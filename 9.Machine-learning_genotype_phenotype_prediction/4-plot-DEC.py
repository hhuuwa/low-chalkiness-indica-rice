...
for model_name in model_list:
    for pre_name in pre_list:
        with open(os.path.join(TEST_RES_PATH, "{}-{}-DEC_BLUE.pickle".format(model_name, pre_name)), "rb") as in_f:
